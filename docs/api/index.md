...
Low-level functions for phase-space operations. Available in the `localflowwalk.phasespace` submodule.

```{eval-rst}
.. currentmodule:: localflowwalk.phasespace
...
```{eval-rst}
.. autoclass:: localflowwalk.nn.Autoencoder
   :no-index:
   :members: encode, decode, decode_position, predict
   :show-inheritance:

.. autoclass:: localflowwalk.nn.InterpolationNetwork
   :no-index:
   :members: __call__
   :show-inheritance:

.. autoclass:: localflowwalk.nn.ParamNet
   :no-index:
   :members: __call__
   :show-inheritance:

.. autoclass:: localflowwalk.nn.PhaseSpaceDataSource
   :no-index:
...
.. autoclass:: localflowwalk.nn.AutoencoderResult
   :no-index:
   :members:
```
